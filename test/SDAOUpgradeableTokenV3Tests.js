...
var  SDAOUpgradeableTokenV3 = artifacts.require("SDAOUpgradeableTokenV3.sol");
...
contract('SDAOUpgradeableTokenV3', function(accounts) {
    ...
    before(async () => 
        {
            ...
            //sdaoUpgradeableToken = await SDAOUpgradeableTokenV2.deployed();
            const sdaoUpgradeableToken_Old = await deployProxy(SDAOUpgradeableTokenV2,[name, symbol, initialSupply] , { initializer: 'initialize'});

            // upgrade the Proxy

            sdaoUpgradeableToken = await upgradeProxy(sdaoUpgradeableToken_Old, SDAOUpgradeableTokenV3);
